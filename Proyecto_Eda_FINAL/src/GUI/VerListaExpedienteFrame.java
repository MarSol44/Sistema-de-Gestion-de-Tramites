...
public class VerListaExpedienteFrame extends javax.swing.JFrame {
    private DefaultTableModel modeloTabla;// Modelo para manejar la tabla
    ...
    public VerListaExpedienteFrame(SistemaGestion sistema) {
        initComponents();
        this.miSistema = sistema; // Guarda el sistema que viene desde otra ventana
        
        // Configura el modelo de la tabla
        configurarTabla();
        //Llama a los datos del sistema y los coloca en la tabla
        cargarDatosTabla();
    }
    ...
    private void cargarDatosTabla() {
       ...
       //Se crea lista, llamando a la lista doblemente enlazada de expedientes (los exp que se agregaron antes)
        ...
        while (actual != null) {
            Expediente e = actual.getDato(); //  getDato de NodoDoble, primero saca el expediente del nodo,
            Interesados i = e.getInteresado(); // getExpediente de NodoDOble, luego saca el interesado del expediente
            
            Object[] fila = new Object[6];//Arreglo de objetos
            fila[0] = e.getIdUnico();
            fila[1] = e.getAsunto();
