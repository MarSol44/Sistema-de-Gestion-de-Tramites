...
public class RegistrarMovimientoFrame extends javax.swing.JFrame {
    ...
    // BOTON: CARGAR, PARA EL ID
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    String idExpediente = txtIdExpediente.getText().trim();//Agarra el ID ingresado
    ...
    if (exp != null) {
        // 2. Obtenemos último movimiento/seguimiento para saber la dependencia actual
        ...
        comboDependenciaDestino.removeAll(); // Limpiamos las opciones dependientes destino
        //dependencias con todos los nombres de dependencias
        java.util.ArrayList<String> dependencias = miSistema.getNombresDeDependencias();
        
        //los pone n dependencia destino
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        //obtiene el texto de IDEXPEDIENTE
        String idExpediente = txtIdExpediente.getText().trim();
        //obtiene texto en el campo ID de expediente
        ...
        // esta en Sist. Gestion, donde registra la fecha y hora del movimiento automáticamente
