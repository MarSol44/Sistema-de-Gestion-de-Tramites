...
public class FinalizarTramite extends javax.swing.JFrame {
    ...
    if (expFinalizado != null) {
        ...
        // Asegúrate de que tu JTextField para la fecha se llame 'txtFechaFinal'.
    ...
    if (exp == null) {
        ...
        // En lugar del JOptionPane, llenamos los campos de texto.
...
// Método de ayuda para limpiar los campos de información
